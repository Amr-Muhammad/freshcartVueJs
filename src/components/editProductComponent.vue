<template>
    <div class="container">
        <div class="d-flex flex-column vh-100 justify-content-center align-items-center">
            ...
            <!-- <p>{{ this.id }}</p> -->
            <form class="w-50" @submit.prevent="adminEditProdcut(productInfo.id)">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input v-model="productInfo.subcategory[0].name" placeholder="Subcategory" type="text"
...
export default {
    ...
    methods: {
        async adminEditProdcut(productId) {
            await service.methods.adminEditProdcut(productId, this.productInfo)
    ...
    async created() {
        ...
        if (localStorage.getItem('loggedAdminId')) {
            ...
            this.productInfo = (await service.methods.getProductDetails(this.id)).data
